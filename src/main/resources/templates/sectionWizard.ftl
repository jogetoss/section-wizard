...
<#else>
    <#if !(request.getAttribute("org.joget.plugin.SectionWizard")??) >
        ...
        <style type="text/css">
            ...
            .wizard > .easyWizardWrapper > .step{display:block !important; padding:0px !important; border:0px !important; clear: right !important; margin:0 !important; margin-top:0px !important; box-shadow:none !important; }
