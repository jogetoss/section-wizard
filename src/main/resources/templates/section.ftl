...
<#if !(request.getAttribute("org.joget.plugin.SectionWizardChild")??) >
    <script type="text/javascript" src="${request.contextPath}/plugin/org.joget.plugin.SectionWizardChild/js/jquery.sectionWizardChild.js"></script>
</#if>     
...
<script type="text/javascript">
    $('#${elementParamName!}').sectionWizardChild({
